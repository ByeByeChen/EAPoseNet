...
model = dict(
    ...
    backbone=dict(
        ...
        widen_factor=1.,
        out_indices=(4, ),
        use_akconv=False,   #是否在主干网络中使用 akconv
        use_dcnv4=False,    #是否在CSPLayer的CSPNeXtBlock中使用 dcnv4
        use_sppelan=True,  #是否在主干网络中使用 sppelan 替换 SPPF
        channel_attention=True,
        channel_attention_type='SimAM',  #CSPLayer的通道注意力类型
        #channel_attention=True,
