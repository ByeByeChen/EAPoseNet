...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/horse10-train-split1.json',
        #data_prefix=dict(img='labeled-data/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/horse10-test-split1.json',
        #data_prefix=dict(img='labeled-data/'),
        test_mode=True,
...
# val_evaluator = dict(
#     type='CocoMetric',
#     ann_file=data_root + 'annotations/fly_test.json')
val_evaluator = [
    dict(type='CocoMetric', ann_file=data_root + 'annotations/horse10-test-split1.json'),
    dict(type='PCKAccuracy',thr=0.3),
    dict(type='AUC'),
